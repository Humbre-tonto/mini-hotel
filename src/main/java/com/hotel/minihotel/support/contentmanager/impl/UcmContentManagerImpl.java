package com.informatique.gov.helpdesk.support.contentmanager.impl;
...
import com.informatique.gov.helpdesk.support.contentmanager.ContentManager;
...
public class UcmContentManagerImpl implements ContentManager {
	...
	@Override
	public String checkin(Map<String, String> properties, byte[] bytes, String fileName) throws Exception {
		...
		try {
			...
			requestDataBinder.putLocal("dDocTitle", fileName);
			...
			requestDataBinder.addFile("primaryFile", new TransferFile(is, fileName, bytes.length, type));
	...
	@Override
	public String checkin(Map<String, String> properties, String content, String fileName) throws Exception {
		byte[] bytes = Base64.getDecoder().decode(content);
		return checkin(properties, bytes, fileName);
	}
	...
	@Override
	public Map<String, String> getAttachmentProperties(String folder, String attachmentType, String requestSerial)
			throws Exception {
