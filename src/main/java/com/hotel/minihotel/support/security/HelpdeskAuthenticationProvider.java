...
@Component
@AllArgsConstructor
public class HelpdeskAuthenticationProvider implements AuthenticationProvider, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = ShowDogVersion.serialVersionUID;
	private final Logger logger = LoggerFactory.getLogger(HelpdeskAuthenticationProvider.class);
