...
public enum HotelExceptionEnum {
  ...
  //============user errors
    ...
    private HotelExceptionEnum(String code, String description, String fixSuggestion){
        this.code = code;
        this.description = description;
        this.fixSuggestion = fixSuggestion;
    }
    
    private HotelExceptionEnum(String code, String constraintCode, String description, String fixSuggestion){
        this.code = code;
        this.description = description;
        this.fixSuggestion = fixSuggestion;
    ...
    public static HotelExceptionEnum getByCode(String code) {
		for (HotelExceptionEnum value : HotelExceptionEnum.values()) {
    ...
    public static HotelExceptionEnum getByConstraintCode(String constraintCode) {
		for (HotelExceptionEnum value : HotelExceptionEnum.values()) {
